/**
 * Implementasi algoritma gambar garis Digital Differential Analyzer (DDA).
 *
 * Mengimplementasikan gambar garis dengan interpolasi antara titik ujung
 * menggunakan aritmetika bilangan desimal, dengan variasi untuk gaya putus-putus, tebal, dan putus-titik.
 */
#include "dda.h"
#include <math.h>
#include <stdlib.h>
